        ...
        s.prototype = {
            observe: function(t, e) {
              ...
              (e.characterDataOldValue && !e.characterData))
                ...
                i || ((i = new f(this, t, e)), o.push(i), this.nodes_.push(t)),
                i.addListeners();
            },
            disconnect: function() {
...
window.CustomElements.addModule(function(t) {
    ...
    function n(t, e, o) {
        ...
        if (!i)
            for (i = t.firstChild; i && i.nodeType !== Node.ELEMENT_NODE; )
                i = i.nextSibling;
    ...
    function r(t, e, n) {
        if (((t = window.wrap(t)), !(n.indexOf(t) >= 0))) {
            ...
            for (
                var o,
                    i = t.querySelectorAll("link[rel=" + s + "]"),
                    a = 0,
                    u = i.length;
                u > a && (o = i[a]);
                a++
            )
                o.import && r(o.import, e, n);
            e(t);
        }
    }
    ...
    function d(t, n) {
        if (v.dom) {
            ...
            if (o && "childList" === o.type && o.addedNodes && o.addedNodes) {
                for (var i = o.addedNodes[0]; i && i !== document && !i.host; )
                    i = i.parentNode;
                var r =
...
window.CustomElements.addModule(function(t) {
    function e(e, o) {
        if (
          ...
          HTMLTemplateElement.decorate(e),
            ...
            if (r && ((i && r.tag == e.localName) || (!i && !r.extends)))
                return n(e, r, o);
        }
    }
    function n(e, n, i) {
    ...
    function o(t, e) {
        Object.__proto__
            ...
            : (i(t, e.prototype, e.native), (t.__proto__ = e.prototype));
    }
    function i(t, e, n) {
        for (var o = {}, i = e; i !== n && i !== HTMLElement.prototype; ) {
            for (var r, s = Object.getOwnPropertyNames(i), a = 0; (r = s[a]); a++)
                o[r] ||
...
window.CustomElements.addModule(function(t) {
    ...
    function o(t, e, n) {
        ...
        i !== o &&
        this.attributeChangedCallback(t, o, i);
    }
    function i(t) {
    ...
    function s(t) {
        for (var e, n = t.extends, o = 0; (e = t.ancestry[o]); o++)
            n = e.is && e.tag;
    ...
    function d(t, e) {
        ...
        var o;
        return e
            ? ((o = d(t)), o.setAttribute("is", e), o)
            : ((o = E(t)), t.indexOf("-") >= 0 && b(o, HTMLElement), o);
    }
    function f(t, e) {
        var n = t[e];
        t[e] = function() {
    ...
    (function() {
                ...
                return (
                    ...
                    (o.prototype.inspect = function() {
                        ...
                        return (
                            (t = function() {
                                var t, o, i;
                                (o = null != (t = this.contentsForInspection()) ? t : {}),
                                (i = []);
        ...
        function() {
            ...
            (n = function(n, o) {
                ...
                return n.isEqualTo(o)
                    ...
                    (s = a
                        ...
                        t(o, e.UTF16String.fromCodepoints(i)))
                        : t(o, n)),
            ...
            (t = function(t, e) {
                var n, o, i;
                for (
                    n = 0, o = t.length, i = e.length;
                    o > n && t.charAt(n).isEqualTo(e.charAt(n));

                )
                    n++;
                for (; o > n + 1 && t.charAt(o - 1).isEqualTo(e.charAt(i - 1)); )
                    o--, i--;
            ...
            e.extend({
                ...
                summarizeArrayChange: function(t, e) {
                    ...
                    for (
                        ...
                        (p = t[r]), i.add(p);
                    for (o = new Set(), s = 0, c = e.length; c > s; s++)
                        (p = e[s]), o.add(p), i.has(p) || n.push(p);
                    for (a = 0, l = t.length; l > a; a++)
                        (p = t[a]), o.has(p) || h.push(p);
        ...
        function() {
            ...
            e.extend({
                ...
                getTextAttributeNames: function() {
                    return null != i
                        ? i
                        : (i = Object.keys(e.config.textAttributes));
                },
                getListAttributeNames: function() {
                    ...
                    return null != o
                        ...
                        : (o = (function() {
                            ...
                            for (t in o)
                                (n = o[t].listAttribute), null != n && i.push(n);
                            return i;
                        })());
                }
            });
        ...
        function() {
            ...
            e.extend({
                ...
                findElementFromContainerAndOffset: function(t, n) {
                    var o;
                    return (
                        (o = e.findNodeFromContainerAndOffset(t, n)),
                        e.findClosestElementFromNode(o)
                    );
                },
                ...
                makeElement: function(t, e) {
                    ...
                    if (e.className)
                        for (
                            l = e.className.split(" "), i = 0, s = l.length;
                            s > i;
                            i++
                        )
                            (n = l[i]), o.classList.add(n);
                ...
                cloneFragment: function(t) {
                    ...
                    for (
                        ...
                        (i = r[n]), e.appendChild(i.cloneNode(!0));
                    return e;
                },
                ...
                nodeProbablyIsBlockContainer: function(t) {
                    ...
                    ((o = e.tagName(t.firstChild)),
                    s.call(e.getBlockTagNames(), o) < 0)
                    );
                },
                nodeIsBlockStart: function(t, n) {
                    var o;
                    return (
                        (o = (null != n ? n : { strict: !0 }).strict),
                        o
        ...
        function() {
            ...
            e.extend({
                ...
                rangeIsCollapsed: function(t) {
                    var e, n, i;
                    if (null != t)
                        return (n = o(t)), (i = n[0]), (e = n[1]), r(i, e);
                },
        ...
        function() {
            ...
            (i = function(t) {
                ...
                n = {};
                for (e in t)
                    (o = t[e]), (n[e] = "function" == typeof o ? { value: o } : o);
                return n;
            });
        }.call(this),
        function() {
            ...
            e.extend({
                ...
                getDOMRange: function() {
                    var n, o;
                    return (n =
                null != (o = e.getDOMSelection()) ? o.getRangeAt(0) : void 0) &&
                !t(n)
                        ? n
                        : void 0;
                },
                ...
                return (
                    ...
                    (i.prototype.slice = function(t) {
                        ...
                        for (r = {}, n = 0, i = t.length; i > n; n++)
                            (o = t[n]), this.has(o) && (r[o] = this.values[o]);
                        return new e.Hash(r);
                    }),
                    ...
                    (i.prototype.getKeysCommonToHash = function(t) {
                        var e, n, o, i, s;
                        for (
                            t = r(t), i = this.getKeys(), s = [], e = 0, o = i.length;
                            o > e;
                            e++
                        )
                            (n = i[e]), this.values[n] === t.values[n] && s.push(n);
                        return s;
                    }),
                    ...
                    (s = function(t, e) {
                        var n, o, i, r, s;
                        for (
                            r = {}, s = Object.keys(t).sort(), n = 0, i = s.length;
                            i > n;
                            n++
                        )
                            (o = s[n]), o !== e && (r[o] = t[o]);
                            ...
                            if (((u = t[s]), r)) {
                                if (
                                    ("function" == typeof u.canBeGrouped
                                        ...
                                        : void 0) &&
                      ("function" ==
                      typeof (o = r[r.length - 1]).canBeGroupedWith
                          ? o.canBeGroupedWith(u, i)
                          : void 0)
                                ) {
                                    r.push(u);
                                    continue;
        ...
        function() {
            ...
            e.ObjectMap = (function(e) {
                function n(t) {
                    var e, n, o, i, r;
                    for (
                        null == t && (t = []), this.objects = {}, o = 0, i = t.length;
                        i > o;
                        o++
                    )
                        (r = t[o]),
            ...
            e.ElementStore = (function() {
                ...
                return (
                    ...
                    (t.prototype.remove = function(t) {
                        ...
                        return (
                            (n = e(t)),
                            (o = this.elements[n]) ? (delete this.elements[n], o) : void 0
                        );
                    }),
                ...
                : function(t) {
                    ...
                    return (
                        (e = (function() {
                            ...
                            (o = 56320 | (1023 & o))),
                                r.push(n + String.fromCharCode(o));
                            return r;
                        })()),
                        e.join("")
                    );
                ...
                href: {
                    ...
                    parser: function(t) {
                        ...
                        return (
                            ...
                            (i = "a:not(" + n + ")"),
                            (o = e.findClosestElementFromNode(t, { matchingSelector: i }))
                                ? o.getAttribute("href")
                                : void 0
                        );
                    }
            ...
            e.extend({
                serializers: {
                    ...
                    "text/html": function(s) {
                        ...
                        for (
                            w = l.querySelectorAll(o), f = 0, v = w.length;
                            v > f;
                            f++
                        ) {
                            c = w[f];
        ...
        function() {
            ...
            (e.config.toolbar = {
                content: n(
                    "<div class=\"button_row\">\n  <span class=\"button_group text_tools\">\n    <button type=\"button\" class=\"icon bold\" data-trix-attribute=\"bold\" data-trix-key=\"b\" title=\"" +
                  t.bold +
                  "\">" +
                  t.bold +
                  "</button>\n    <button type=\"button\" class=\"icon italic\" data-trix-attribute=\"italic\" data-trix-key=\"i\" title=\"" +
                  t.italic +
                  "\">" +
                  t.italic +
                  "</button>\n    <button type=\"button\" class=\"icon strike\" data-trix-attribute=\"strike\" title=\"" +
                  t.strike +
                  "\">" +
                  t.strike +
                  "</button>\n    <button type=\"button\" class=\"icon link\" data-trix-attribute=\"href\" data-trix-action=\"link\" data-trix-key=\"k\" title=\"" +
                  t.link +
                  "\">" +
                  t.link +
                  "</button>\n  </span>\n\n  <span class=\"button_group block_tools\">\n    <button type=\"button\" class=\"icon heading-1\" data-trix-attribute=\"heading1\" title=\"" +
                  t.heading1 +
                  "\">" +
                  t.heading1 +
                  "</button>\n    <button type=\"button\" class=\"icon quote\" data-trix-attribute=\"quote\" title=\"" +
                  t.quote +
                  "\">" +
                  t.quote +
                  "</button>\n    <button type=\"button\" class=\"icon code\" data-trix-attribute=\"code\" title=\"" +
                  t.code +
                  "\">" +
                  t.code +
                  "</button>\n    <button type=\"button\" class=\"icon list bullets\" data-trix-attribute=\"bullet\" title=\"" +
                  t.bullets +
                  "\">" +
                  t.bullets +
                  "</button>\n    <button type=\"button\" class=\"icon list numbers\" data-trix-attribute=\"number\" title=\"" +
                  t.numbers +
                  "\">" +
                  t.numbers +
                  "</button>\n    <button type=\"button\" class=\"icon nesting-level decrease\" data-trix-action=\"decreaseNestingLevel\" title=\"" +
                  t.outdent +
                  "\">" +
                  t.outdent +
                  "</button>\n    <button type=\"button\" class=\"icon nesting-level increase\" data-trix-action=\"increaseNestingLevel\" title=\"" +
                  t.indent +
                  "\">" +
                  t.indent +
                  "</button>\n  </span>\n\n  <span class=\"button_group history_tools\">\n    <button type=\"button\" class=\"icon undo\" data-trix-action=\"undo\" data-trix-key=\"z\" title=\"" +
                  t.undo +
                  "\">" +
                  t.undo +
                  "</button>\n    <button type=\"button\" class=\"icon redo\" data-trix-action=\"redo\" data-trix-key=\"shift+z\" title=\"" +
                  t.redo +
                  "\">" +
                  t.redo +
            ...
            e.registerElement("trix-toolbar", {
                ...
                createdCallback: function() {
                    return "" === this.innerHTML
                        ? this.appendChild(t(e.config.toolbar.content))
                        : void 0;
                }
            });
        }.call(this),
        function() {
            ...
            e.ObjectView = (function(n) {
                ...
                return (
                    ...
                    ((o.viewClass = t), (t = e.ObjectGroupView)),
                            (i = new t(n, o)),
                    ...
                    (i.prototype.getAllChildViews = function() {
                        var t, e, n, o, i;
                        for (
                            i = [], o = this.childViews, e = 0, n = o.length;
                            n > e;
                            e++
                        )
                            (t = o[e]), i.push(t), (i = i.concat(t.getAllChildViews()));
                        return i;
                    }),
                    ...
                    (i.prototype.findViewForObject = function(t) {
                        var e, n, o, i;
                        for (
                            o = this.getAllChildViews(), e = 0, n = o.length;
                            n > e;
                            e++
                        )
                ...
                return (
                    ...
                    (n.prototype.getChildViews = function() {
                        ...
                        if (!this.childViews.length)
                            for (
                                o = this.objectGroup.getObjects(), t = 0, e = o.length;
                                e > t;
                                t++
                            )
                                (n = o[t]),
                    ...
                    (n.prototype.createNodes = function() {
                        ...
                        for (
                            ...
                            for (
                                u = s[e], a = u.getNodes(), n = 0, i = a.length;
                                i > n;
                                n++
                            )
        ...
        function() {
            ...
            (o = e.nodeIsBlockStartComment),
            (r = e.normalizeSpaces),
            (s = e.summarizeStringChange),
            (a = e.tagName),
            (e.MutationObserver = (function(t) {
                function e(t) {
                    (this.element = t),
                    (this.didMutate = u(this.didMutate, this)),
                ...
                return (
                    ...
                    (e.prototype.findSignificantMutations = function(t) {
                        ...
                        for (i = [], e = 0, n = t.length; n > e; e++)
                            (o = t[e]), this.mutationIsSignificant(o) && i.push(o);
                        return i;
                    }),
                    (e.prototype.mutationIsSignificant = function(t) {
                        var e, n, o, i;
                        for (
                            i = this.nodesModifiedByMutation(t), e = 0, n = i.length;
                            n > e;
                            e++
                        )
                    ...
                    (e.prototype.getTextMutationSummary = function() {
                        ...
                        for (
                            ...
                            n = a.additions,
                            i = a.deletions,
                            l = this.getTextChangesFromChildList(),
                            u = l.additions,
                            r = 0,
                            s = u.length;
                            s > r;
                            ...
                            (e = u[r]), h.call(n, e) < 0 && n.push(e);
                        return (
                            i.push.apply(i, l.deletions),
                            (c = {}),
                            (t = n.join("")) && (c.textAdded = t),
                            (o = i.join("")) && (c.textDeleted = o),
                            c
                        );
                    }),
                    (e.prototype.getMutationsByType = function(t) {
                        var e, n, o, i, r;
                        for (
                            i = this.mutations, r = [], e = 0, n = i.length;
                            n > e;
                            e++
                        )
                            (o = i[e]), o.type === t && r.push(o);
                        return r;
                    }),
                    (e.prototype.getTextChangesFromChildList = function() {
                        ...
                        return (
                            (c = 0 === t.length && 1 === u.length && o(u[0])),
                            c ? ((p = []), (d = ["\n"])) : ((p = l(t)), (d = l(u))),
                            {
                                additions: (function() {
                                    var t, e, o;
                                    for (o = [], n = t = 0, e = p.length; e > t; n = ++t)
                                        (h = p[n]), h !== d[n] && o.push(r(h));
                                    return o;
                                })(),
                                deletions: (function() {
                                    var t, e, o;
                                    for (o = [], n = t = 0, e = d.length; e > t; n = ++t)
                                        (h = d[n]), h !== p[n] && o.push(r(h));
                                    return o;
                                })()
                            }
                        );
        ...
        function() {
            ...
            (o = e.defer),
            (p = e.makeElement),
            (u = e.innerElementIsActive),
            (g = e.summarizeStringChange),
            (d = e.objectsAreEqual),
            (m = e.tagName),
                ...
                return (
                    ...
                    (r.prototype.attachFiles = function(t) {
                        ...
                        return (
                            (o = (function() {
                                var o, i, r;
                                for (r = [], o = 0, i = t.length; i > o; o++)
                                    (n = t[o]), r.push(new e.FileVerificationOperation(n));
                                return r;
                            })()),
                            Promise.all(o).then(
                                (function(t) {
                                ...
                                i.inputControllerWillAttachFiles(),
                                                t = 0,
                                                o = e.length;
                                                o > t;
                                                t++
                                                ...
                                                (n = e[t]),
                                                null != (r = this.responder) && r.insertFile(n);
                    ...
                    (r.prototype.events = {
                        keydown: function(t) {
                            ...
                            if (
                                ...
                                (r = this.constructor.keyNames[t.keyCode]))
                            ) {
                                for (
                                    o = this.keys,
                                    l = ["ctrl", "alt", "shift", "meta"],
                                    i = 0,
                                    a = l.length;
                                    a > i;
                                    i++
                      ...
                      ((s = (function() {
                          var e, n, o, i;
                          for (
                              o = ["alt", "shift"], i = [], e = 0, n = o.length;
                              n > e;
                              e++
                          )
                              (u = o[e]), t[u + "Key"] && i.push(u);
                          return i;
                      })()),
                      s.push(n),
                      null != (h = this.delegate)
                          ? h.inputControllerDidReceiveKeyboardCommand(s)
                          : void 0)
                                ? t.preventDefault()
                                : void 0;
                        },
                      ...
                      !l(t)
                            ...
                            (e = String.fromCharCode(t.charCode)),
                              ...
                              n.inputControllerWillPerformTyping(),
                                        null != (o = this.responder) && o.insertString(e),
                      ...
                      d(e, this.draggingPoint))
                        ...
                        drop: function(t) {
                            ...
                            return (
                                t.preventDefault(),
                                (i = null != (s = t.dataTransfer) ? s.files : void 0),
                        ...
                        a.setLocationRangeFromPointRange(r),
                            ...
                            c.moveTextFromRange(this.draggedRange),
                                        (this.draggedRange = null),
                                        this.requestRender())
                                        : (o = t.dataTransfer.getData(
                                            "application/x-trix-document"
                                        )) &&
                          ((n = e.Document.fromJSONString(o)),
                        ...
                        copy: function(t) {
                            return this.serializeSelectionToDataTransfer(
                                t.clipboardData
                            )
                                ? t.preventDefault()
                                : void 0;
                        ...
                        null != (h = n.clipboardData)
                            ...
                            : n.testClipboardData),
                                        ...
                                        (function(t) {
                                            return function(e) {
                                                ...
                                                return (
                                                    (l.html = e),
                                                    null != (n = t.delegate) &&
                                    n.inputControllerWillPasteText(l),
                                                    null != (o = t.responder) && o.insertHTML(e),
                                                    t.requestRender(),
                                                    null != (i = t.delegate)
                                ...
                                p.inputControllerWillPasteText(l),
                                        null != (b = this.responder) && b.insertString(L),
                                        this.requestRender(),
                                        null != (C = this.delegate) &&
                                C.inputControllerDidPaste(l))
                                        : (u = c.getData("text/html"))
                                            ? ((l.html = u),
                                            null != (w = this.delegate) &&
                                w.inputControllerWillPasteText(l),
                                            null != (x = this.responder) && x.insertHTML(u),
                                            this.requestRender(),
                                            null != (E = this.delegate) &&
                                E.inputControllerDidPaste(l))
                                            : (a = c.getData("URL"))
                                                ? ((l.string = a),
                                                this.setInputSummary({
                                                    textAdded: a,
                                ...
                                S.inputControllerWillPasteText(l),
                                                null != (k = this.responder) &&
                                k.insertText(
                                    e.Text.textForStringWithAttributes(a, {
                                        href: a
                                    })
                                ),
                                                this.requestRender(),
                                ...
                                R.inputControllerDidPaste(l))
                                                : A.call(c.types, "Files") >= 0 &&
                              (r =
                                null != (d = c.items) &&
                                null != (g = d[0]) &&
                                "function" == typeof g.getAsFile
                                    ? g.getAsFile()
                                    : void 0) &&
                              (!r.name &&
                                (o = i(r)) &&
                                (r.name = "pasted-file-" + ++s + "." + o),
                              (l.file = r),
                              null != (m = this.delegate) &&
                                m.inputControllerWillAttachFiles(),
                              null != (y = this.responder) && y.insertFile(r),
                              this.requestRender(),
                              null != (v = this.delegate) &&
                                v.inputControllerDidPaste(l)),
                                    n.preventDefault())
                            );
                        },
                    ...
                    (r.prototype.getCompositionInput = function() {
                        return this.isComposing()
                            ...
                            : (this.compositionInput = new e.CompositionInput(this));
                    }),
                    ...
                    (r.prototype.serializeSelectionToDataTransfer = function(t) {
                        ...
                        null != (i = this.responder)
                            ...
                            : void 0),
                                ...
                                t.setData(
                                    "text/html",
                                    e.DocumentView.render(o).innerHTML
                                ),
                                t.setData("text/plain", o.toString().replace(/\n$/, "")),
                                !0
                            );
                    }),
                    (r.prototype.canAcceptDataTransfer = function(t) {
                        ...
                        for (
                            s = {},
                            i = null != (o = null != t ? t.types : void 0) ? o : [],
                            e = 0,
                            n = i.length;
                            n > e;
                            e++
                    ...
                    (r.prototype.getPastedHTMLUsingHiddenElement = function(t) {
                        ...
                        return (
                            ...
                            (e = p({ style: o, tagName: "div", editable: !0 })),
                    ...
                    r.proxyMethod("responder?.getSelectedRange"),
                    r.proxyMethod("responder?.setSelectedRange"),
                    r.proxyMethod("responder?.expandSelectionInDirection"),
                    r.proxyMethod("responder?.selectionIsInCursorTarget"),
            ...
            (f = function(t) {
                ...
                return (n = null != (e = t.clipboardData) ? e.types : void 0)
                    ? A.call(n, "text/html") < 0 &&
                    (A.call(n, "com.apple.webarchive") >= 0 ||
                      A.call(n, "com.apple.flat-rtfd") >= 0)
                    : void 0;
            }),
            (t = function(t) {
                var e, n, o;
                return (
                    (o = t.getData("text/plain")),
            ...
            (y = { "application/x-trix-feature-detection": "test" }),
            (n = function(t) {
                var e, n;
        ...
        function() {
            ...
            (r = e.makeElement),
            (s = e.tagName),
            (o = e.InputController.keyNames),
            (i = e.config.lang),
            (t = e.config.css.classNames),
            (e.AttachmentEditorController = (function(e) {
                function c(t, e, n) {
                    (this.attachmentPiece = t),
                    (this.element = e),
                    (this.container = n),
                    (this.uninstall = a(this.uninstall, this)),
                    (this.didKeyDownCaption = a(this.didKeyDownCaption, this)),
                    (this.didChangeCaption = a(this.didChangeCaption, this)),
                    (this.didClickCaption = a(this.didClickCaption, this)),
                    (this.didClickRemoveButton = a(
                        this.didClickRemoveButton,
                        this
                    )),
                ...
                return (
                    ...
                    (c.prototype.editCaption = l(function() {
                        ...
                        return (
                            ...
                            (e = function() {
                                return (
                                    (u.value = a.value),
                                    (a.style.height = u.scrollHeight + "px")
                                );
                            }),
                            n("input", { onElement: a, withCallback: e }),
                            n("keydown", {
                                onElement: a,
                            ...
                            n("blur", { onElement: a, withCallback: this.uninstall }),
                            ...
                            (o = s.cloneNode()),
                            {
                                do: function() {
                                    return (
                                        ...
                                        o.appendChild(a),
                                        o.appendChild(u),
                                        o.classList.add(t.attachment.editingCaption),
                                ...
                                undo: function() {
                                    return (
                                        o.parentNode.removeChild(o), (s.style.display = null)
                                    );
                                }
                            }
                        );
                    ...
                    (c.prototype.didChangeCaption = function(t) {
                        ...
                        "function" ==
                          typeof o.attachmentEditorDidRequestRemovingAttributeForAttachment
                                    ? o.attachmentEditorDidRequestRemovingAttributeForAttachment(
                                        "caption",
                                        this.attachment
                                    )
                                    : void 0
        ...
        function() {
            var t,
                ...
                s = {}.hasOwnProperty;
            (o = e.makeElement),
            (i = e.selectionElements),
            (t = e.config.css.classNames),
            (e.AttachmentView = (function(e) {
                function s() {
                ...
                return (
                    ...
                    (s.prototype.createNodes = function() {
                        ...
                        if (
                            ...
                            s.innerHTML = this.attachment.getContent();
                        else
                            for (
                                p = this.createContentNodes(), u = 0, l = p.length;
                                l > u;
                                u++
                            )
                                (h = p[u]), s.appendChild(h);
                        s.appendChild(this.createCaptionElement()),
                        (n = {
                        ...
                        e.isEmpty() || (n.trixAttributes = JSON.stringify(e)),
                        this.attachment.isPending() &&
                      ((this.progressElement = o({
                          tagName: "progress",
                          attributes: {
                      ...
                      s.appendChild(this.progressElement),
                      (n.trixSerialize = !1)),
                        (a = this.getHref())
                            ? ((r = o("a", { href: a })), r.appendChild(s))
                            : (r = s);
                        for (c in n) (d = n[c]), (r.dataset[c] = d);
                        return (
                            r.setAttribute("contenteditable", !1),
                            [i.create("cursorTarget"), r, i.create("cursorTarget")]
                        );
                    }),
                    (s.prototype.createCaptionElement = function() {
                        ...
                        return (
                            ...
                            (e = this.attachmentPiece.getCaption())
                                ? (n.classList.add(t.attachment.captionEdited),
                                (n.textContent = e))
                                : (i = this.attachment.getFilename()) &&
                        ((n.textContent = i),
        ...
        function() {
            ...
            (n = e.makeElement),
            (o = e.measureElement),
            (e.PreviewableAttachmentView = (function(t) {
                function e() {
                ...
                return (
                    i(e, t),
                    (e.prototype.createContentNodes = function() {
                        return (
                            (this.image = n({
                                tagName: "img",
                                attributes: { src: "" },
                    ...
                    (e.prototype.updateAttributesForImage = function(t) {
                        ...
                        return (
                            ...
                            n === r
                                ...
                                : ((o = JSON.stringify({ src: r })),
                                t.setAttribute("data-trix-serialized-attributes", o)),
                ...
                return (
                    ...
                    (s.prototype.createNodes = function() {
                        ...
                        if (
                            ...
                            for (o = t(e), n = 0, i = s.length; i > n; n++)
                                (r = s[n]), o.appendChild(r);
                            s = [e];
                        }
                        return s;
                    }),
                    ...
                    (s.prototype.createContainerElement = function() {
                        ...
                        r = this.attributes;
                        for (i in r)
                            if (((s = r[i]), (e = n(i)) && e.groupTagName))
                                return (t = {}), (t[i] = s), o(e.groupTagName, t);
                    }),
            ...
            e.TextView = (function(n) {
                ...
                return (
                    ...
                    (o.prototype.getPieces = function() {
                        var t, e, n, o, i;
                        for (
                            o = this.text.getPieces(), i = [], t = 0, e = o.length;
                            e > t;
                            t++
                        )
                            (n = o[t]), n.hasAttribute("blockBreak") || i.push(n);
                        return i;
                    }),
                    (i = function(t) {
                    ...
                    (r.prototype.createNodes = function() {
                        ...
                        if (
                            ...
                            this.block.isEmpty()
                                ? u.push(n("br"))
                                : ((l =
                          null != (c = t(this.block.getLastAttribute()))
                              ? c.text
                              : void 0),
                                ...
                                this.shouldAddExtraNewlineElement() && u.push(n("br"))),
                            this.attributes.length)
                        )
                            return u;
                        for (
                            i = n(e.config.blockAttributes["default"].tagName),
                            r = 0,
                            s = u.length;
                            s > r;
                            r++
            ...
            (e.DocumentView = (function(i) {
                ...
                return (
                            ...
                            for (
                                ...
                                a.push(
                                    function() {
                                        var t, e, n, o;
                                        for (
                                            n = u.getNodes(), o = [], t = 0, e = n.length;
                                            e > t;
                                            t++
                                        )
                                            (i = n[t]),
                                            o.push(this.shadowElement.appendChild(i));
                                        return o;
                                    }.call(this)
                                );
                            return a;
                    ...
                    (r.prototype.createDocumentFragmentForSync = function() {
                        ...
                        for (c = a(e), o = 0, r = c.length; r > o; o++)
                            (t = c[o]),
        ...
        function() {
            ...
            (e.CompositionController = (function(o) {
                function s(n, o) {
                    (this.element = n),
                    (this.composition = o),
                    (this.didClickAttachment = a(this.didClickAttachment, this)),
                ...
                return (
                    ...
                    (s.prototype.installAttachmentEditorForAttachment = function(
                        t
                    ) {
                        var n, o, i;
                        if (
                            (null != (i = this.attachmentEditor)
                                ? i.attachment
                                : void 0) !== t &&
                    (o = this.documentView.findElementForObject(t))
                            ...
                            return (
                                ...
                                (n = this.composition.document.getAttachmentPieceForAttachment(
                                    t
                                )),
                    ...
                    (s.prototype.attachmentEditorDidRequestUpdatingAttributesForAttachment = function(
                        t,
                        e
                    ) {
                        var n;
                    ...
                    (s.prototype.attachmentEditorDidRequestRemovingAttributeForAttachment = function(
                        t,
                        e
                    ) {
                        var n;
                    ...
                    (s.prototype.attachmentEditorDidRequestRemovalOfAttachment = function(
                        t
                    ) {
                        var e;
                    ...
                    (s.prototype.attachmentEditorDidRequestDeselectingAttachment = function(
                        t
                    ) {
                        var e;
                        return null != (e = this.delegate) &&
        ...
        function() {
            ...
            (e.ToolbarController = (function(e) {
                ...
                return (
                    r(s, e),
                    (a = "button[data-trix-action]"),
                    (c = "button[data-trix-attribute]"),
                    (y = [a, c].join(", ")),
                    (p = ".dialog[data-trix-dialog]"),
                    (u = p + ".active"),
                    (l = p + " input[data-trix-method]"),
                    (h = p + " input[type=text], " + p + " input[type=url]"),
                    (s.prototype.didClickActionButton = function(t, e) {
                        var n, o, i;
                        return (
                            null != (o = this.delegate) && o.toolbarDidClickButton(),
                            t.preventDefault(),
                            (n = d(e)),
                            this.getDialog(n)
                                ? this.toggleDialog(n)
                    ...
                    (s.prototype.didClickDialogButton = function(e, n) {
                        var o, i;
                        return (
                            (o = t(n, { matchingSelector: p })),
                            (i = n.getAttribute("data-trix-method")),
                            this[i].call(this, o)
                        );
                    }),
                    ...
                    (s.prototype.eachAttributeButton = function(t) {
                        var e, n, o, i, r;
                        for (
                            i = this.element.querySelectorAll(c),
                            r = [],
                            n = 0,
                            o = i.length;
                            o > n;
                    ...
                    (s.prototype.applyKeyboardCommand = function(t) {
                        ...
                        for (
                            ...
                            if (
                                ((e = u[r]),
                                (i = e.getAttribute("data-trix-key").split("+")),
                                (n = JSON.stringify(i.sort())),
                                n === s)
                            )
                                return o("mousedown", { onElement: e }), !0;
                        return !1;
                    }),
                    ...
                    (s.prototype.showDialog = function(t) {
                        ...
                        for (
                            ...
                            u = o.querySelectorAll("input[disabled]"),
                            i = 0,
                            s = u.length;
                            s > i;
                            i++
                        )
                            (n = u[i]), n.removeAttribute("disabled");
                        return (
                            (e = f(o)) &&
                      (r = m(o, t)) &&
                    ...
                    (s.prototype.setAttribute = function(t) {
                        ...
                        return (
                            ...
                            n.willValidate && !n.checkValidity()
                                ...
                                : (null != (o = this.delegate) &&
                          o.toolbarDidUpdateAttribute(e, n.value),
                                this.hideDialog())
                        );
                    }),
                    ...
                    (s.prototype.resetDialogInputs = function() {
                        var t, e, n, o, i;
                        for (
                            o = this.element.querySelectorAll(h),
                            i = [],
                            t = 0,
                            n = o.length;
                            n > t;
                            ...
                            i.push(e.classList.remove("validate"));
                        return i;
                    }),
                    (s.prototype.getDialog = function(t) {
                        return this.element.querySelector(
                            ".dialog[data-trix-dialog=" + t + "]"
                        );
                    }),
                    (m = function(t, e) {
                        return (
            ...
            e.Attachment = (function(o) {
                ...
                return (
                    ...
                    (i.prototype.setPreviewURL = function(t) {
                      ...
                      "function" == typeof e.attachmentDidChangePreviewURL &&
                      e.attachmentDidChangePreviewURL(this),
                            null != (n = this.delegate) &&
                    ...
                    (i.prototype.preload = function(t, n) {
                        ...
                        return t && t !== this.getPreviewURL()
                            ...
                            (o = new e.ImagePreloadOperation(t)),
                            o.then(
                                (function(e) {
                                    return function(o) {
                                        var i, r;
                                        return (
                                            (r = o.width),
                                            (i = o.height),
                                            e.setAttributes({ width: r, height: i }),
            ...
            e.Piece.registerType(
                ...
                (e.AttachmentPiece = (function(n) {
                    ...
                    return (
                        ...
                        (o.prototype.ensureAttachmentExclusivelyHasAttribute = function(
                            t
                        ) {
                        ...
                        (o.prototype.canBeGrouped = function() {
                            return (
                                o.__super__.canBeGrouped.apply(this, arguments) &&
                    ...
                    this.attachment.id ===
                      (null != t && null != (e = t.attachment) ? e.id : void 0)
                        ...
                        (o.prototype.toJSON = function() {
                            var t;
                            return (
                                (t = o.__super__.toJSON.apply(this, arguments)),
            ...
            (e.SplittableList = (function(e) {
                ...
                return (
                    ...
                    (o.prototype.splice = function() {
                        ...
                        return (
                            ...
                            new this.constructor(
                                t.apply(null, [this.objects].concat(i.call(e)))
                            )
                        );
                    }),
                    (o.prototype.eachObject = function(t) {
                        var e, n, o, i, r, s;
                        for (
                            r = this.objects, s = [], n = e = 0, o = r.length;
                            o > e;
                            n = ++e
                        )
                            (i = r[n]), s.push(t(i, n));
                    ...
                    (o.prototype.insertSplittableListAtPosition = function(t, e) {
                        var n, o, i;
                        return (
                            (i = this.splitObjectAtPosition(e)),
                            (o = i[0]),
                            (n = i[1]),
                            new this.constructor(o).insertSplittableListAtIndex(t, n)
                        );
                    }),
                    ...
                    (o.prototype.selectSplittableList = function(t) {
                        ...
                        return (
                            (n = function() {
                                var n, o, i, r;
                                for (
                                    i = this.objects, r = [], n = 0, o = i.length;
                                    o > n;
                                    n++
                                )
                                    (e = i[n]), t(e) && r.push(e);
                    ...
                    (o.prototype.splitObjectsAtRange = function(t) {
                        var e, n, o, i, s, u;
                        return (
                            (i = this.splitObjectAtPosition(a(t))),
                            (n = i[0]),
                            (e = i[1]),
                            (o = i[2]),
                    ...
                    (o.prototype.getObjectAtPosition = function(t) {
                        var e, n, o;
                        return (
                            (o = this.findIndexAndOffsetAtPosition(t)),
                            (e = o.index),
                            (n = o.offset),
                            this.objects[e]
                        );
                    ...
                    (o.prototype.consolidateFromIndexToIndex = function(t, e) {
                        ...
                        return (
                            ...
                            this.splice.apply(this, [t, r.length].concat(i.call(n)))
                        );
                    }),
                    (o.prototype.findIndexAndOffsetAtPosition = function(t) {
                        var e, n, o, i, r, s, a;
                        for (
                            e = 0, a = this.objects, o = n = 0, i = a.length;
                            i > n;
                            o = ++n
                        ) {
                            if (((s = a[o]), (r = e + s.getLength()), t >= e && r > t))
                                return { index: o, offset: t - e };
                            e = r;
                        }
                    ...
                    (o.prototype.findPositionAtIndexAndOffset = function(t, e) {
                        var n, o, i, r, s, a;
                        for (
                            s = 0, a = this.objects, n = o = 0, i = a.length;
                            i > o;
                            n = ++o
                        )
                    ...
                    (o.prototype.getEndPosition = function() {
                        ...
                        return null != this.endPosition
                            ...
                            : (this.endPosition = function() {
                                var n, o, i;
                                for (
                                    e = 0, i = this.objects, n = 0, o = i.length;
                                    o > n;
                                    n++
                                )
                                    (t = i[n]), (e += t.getLength());
                    ...
                    (s = function(t, e) {
                        ...
                        for (s = !0, o = n = 0, i = t.length; i > n; o = ++n)
                            (r = t[o]), s && !r.isEqualTo(e[o]) && (s = !1);
                        return s;
                    }),
                    (o.prototype.contentsForInspection = function() {
                        var t;
                      ...
                      function() {
                          var e, n, o, i;
                          for (
                              o = this.objects, i = [], e = 0, n = o.length;
                              n > e;
                              e++
                          )
                              (t = o[e]), i.push(t.inspect());
                          return i;
                      }
                          .call(this)
                          .join(", ") +
            ...
            e.Text = (function(n) {
                function o(t) {
                    ...
                    (this.pieceList = new e.SplittableList(
                        (function() {
                            var e, o, i;
                            for (i = [], e = 0, o = t.length; o > e; e++)
                                (n = t[e]), n.isEmpty() || i.push(n);
                            return i;
                        })()
                    ));
                }
                return (
                    t(o, n),
                    (o.textForAttachmentWithAttributes = function(t, n) {
                        var o;
                    ...
                    (o.fromJSON = function(t) {
                        ...
                        return (
                            (o = (function() {
                                var o, i, r;
                                for (r = [], o = 0, i = t.length; i > o; o++)
                                    (n = t[o]), r.push(e.Piece.fromJSON(n));
                                return r;
                            })()),
                            new this(o)
                        );
                    ...
                    (o.prototype.copyUsingObjectMap = function(t) {
                        ...
                        return (
                            (n = function() {
                                var n, o, i, r, s;
                                for (
                                    i = this.getPieces(), s = [], n = 0, o = i.length;
                                    o > n;
                                    n++
                                )
                                    (e = i[n]), s.push(null != (r = t.find(e)) ? r : e);
                                return s;
                            }.call(this)),
                            new this.constructor(n)
                        );
                    ...
                    (o.prototype.moveTextFromRangeToPosition = function(t, e) {
                        ...
                        if (!(t[0] <= e && e <= t[1]))
                            return (
                                (o = this.getTextAtRange(t)),
                                (n = o.getLength()),
                                t[0] < e && (e -= n),
                                this.removeTextAtRange(t).insertTextAtPosition(o, e)
                            );
                    }),
                    ...
                    (o.prototype.getCommonAttributes = function() {
                        ...
                        return (
                            (t = function() {
                                var t, e, o, i;
                                for (
                                    o = this.pieceList.toArray(), i = [], t = 0, e = o.length;
                                    e > t;
                                    t++
                                )
                                    (n = o[t]), i.push(n.getAttributes());
                                return i;
                            }.call(this)),
                  ...
                  (e = this.getTextAtRange(t).getCommonAttributes())
                    ...
                    (o.prototype.getExpandedRangeForAttributeAtOffset = function(
                        t,
                        e
                    ) {
                        var n, o, i;
                        for (
                            n = i = e, o = this.getLength();
                        ...
                        for (
                            ;
                            o > i && this.getCommonAttributesAtRange([e, i + 1])[t];
                    ...
                    (o.prototype.getAttachmentPieces = function() {
                        ...
                        for (
                            ...
                            (n = o[t]), null != n.attachment && i.push(n);
                        return i;
                    }),
                    (o.prototype.getAttachments = function() {
                        var t, e, n, o, i;
                        for (
                            o = this.getAttachmentPieces(), i = [], t = 0, e = o.length;
                            e > t;
                            t++
                        )
                            (n = o[t]), i.push(n.attachment);
                        return i;
                    }),
                    (o.prototype.getAttachmentAndPositionById = function(t) {
                        var e, n, o, i, r, s;
                        for (
                            i = 0, r = this.pieceList.toArray(), e = 0, n = r.length;
                            n > e;
                            e++
                        ) {
                            if (
                                ((o = r[e]),
                                (null != (s = o.attachment) ? s.id : void 0) === t)
                            )
                                return { attachment: o.attachment, position: i };
                            i += o.length;
                        }
                    ...
                    (o.prototype.getAttachmentById = function(t) {
                        var e, n, o;
                        return (
                            (o = this.getAttachmentAndPositionById(t)),
                            (e = o.attachment),
                            (n = o.position),
                            e
                        );
                    ...
                    (o.prototype.toConsole = function() {
                        ...
                        return JSON.stringify(
                            function() {
                                var e, n, o, i;
                                for (
                                    o = this.pieceList.toArray(), i = [], e = 0, n = o.length;
                                    n > e;
                                    e++
                                )
                                    (t = o[e]), i.push(JSON.parse(t.toConsole()));
                                return i;
                            }.call(this)
                        );
                    }),
            ...
            (e.Block = (function(n) {
                ...
                return (
                    ...
                    (a.prototype.getNestableAttributes = function() {
                        var t, e, n, i, r;
                        for (
                            i = this.attributes, r = [], e = 0, n = i.length;
                            n > e;
                            e++
                        )
                            (t = i[e]), o(t).nestable && r.push(t);
                        return r;
                    }),
                    ...
                    (a.prototype.increaseNestingLevel = function() {
                        ...
                        return (t = this.getLastNestableAttribute())
                            ...
                            (e = r.apply(
                                null,
                                [this.attributes, n + 1, 0].concat(u.call(d(t)))
                            )),
                            this.copyWithAttributes(e))
                            : this;
                    }),
                    (a.prototype.getListItemAttributes = function() {
                        ...
                        for (
                            ...
                            (t = i[e]), o(t).listAttribute && r.push(t);
                        return r;
                    }),
                    (a.prototype.isListItem = function() {
                        var t;
                        return null != (t = o(this.getLastAttribute()))
                            ? t.listAttribute
                            : void 0;
                    }),
                    ...
                    (a.prototype.consolidateWith = function(t) {
                        ...
                        return (
                            ...
                            (o = this.getTextWithoutBlockBreak().appendText(n)),
                            this.copyWithText(o.appendText(t.text))
                        );
                    }),
        ...
        function() {
            ...
            (r = e.makeElement),
            (u = e.tagName),
            (i = e.getBlockTagNames),
            (c = e.walkTree),
            (o = e.findClosestElementFromNode),
            (n = e.elementContainsNode),
            (s = e.nodeIsAttachmentElement),
            (e.HTMLParser = (function(h) {
                function f(t, e) {
                    (this.html = t),
                ...
                return (
                    l(f, h),
                    (g = "style href src width height class".split(" ")),
                    ...
                    (f.prototype.parse = function() {
                        ...
                        try {
                            for (
                                ...
                                e = c(this.containerElement, { usingFilter: E });
                                e.nextNode();
                    ...
                    (R = function(t) {
                        ...
                        for (
                            ...
                            e = n.body,
                            o = n.head,
                            y = o.querySelectorAll("style"),
                            i = 0,
                            a = y.length;
                            a > i;
                            i++
                        )
                            (A = y[i]), e.appendChild(A);
                        for (m = [], C = c(e); C.nextNode(); )
                            switch (((f = C.currentNode), f.nodeType)) {
                            case Node.ELEMENT_NODE:
                                if (b(f)) m.push(f);
                                else
                                    for (
                                        v = p.call(f.attributes), r = 0, u = v.length;
                                        u > r;
                                        r++
                                    )
                                        (h = v[r].name),
                                        d.call(g, h) >= 0 ||
                                0 === h.indexOf("data-trix") ||
                                f.removeAttribute(h);
                                break;
                        ...
                        for (s = 0, l = m.length; l > s; s++)
                            (f = m[s]), f.parentNode.removeChild(f);
                        return e.innerHTML;
                    }),
                    (b = function(t) {
                        return (null != t ? t.nodeType : void 0) !==
                    Node.ELEMENT_NODE || s(t)
                            ? void 0
                            : "script" === u(t) ||
                    ...
                    (f.prototype.appendBlockForElement = function(e) {
                        ...
                        if (
                            ...
                            (i = n(this.currentBlockElement, e)),
                        ...
                        ((o = this.getBlockAttributes(e)),
                        i && t(o, this.currentBlock.attributes))
                                )
                            )
                                return (
                        ...
                        } else if (this.currentBlockElement && !i && !r)
                    ...
                    (f.prototype.appendBlockForAttributesWithElement = function(
                        t,
                        e
                    ) {
                        var n;
                    ...
                    (f.prototype.getBlockAttributes = function(t) {
                        ...
                        for (o = []; t && t !== this.containerElement; ) {
                          ...
                          (("function" == typeof i.test ? i.test(t) : void 0) ||
                            !i.test) &&
                          (o.push(n),
                          i.listAttribute && o.push(i.listAttribute));
                            t = t.parentNode;
                        }
                        return o.reverse();
                    }),
                    ...
                    (f.prototype.translateBlockElementMarginsToNewlines = function() {
                        ...
                        for (
                            ...
                            (t = s[o]),
                            (r = this.getMarginOfBlockElementAtIndex(o)) &&
                        (r.top > 2 * e.top &&
                    ...
                    (f.prototype.getMarginOfDefaultBlockElement = function() {
                        var t;
                        return (
                            (t = r(e.config.blockAttributes["default"].tagName)),
                    ...
                    (y = RegExp("[^\\S" + e.NON_BREAKING_SPACE + "]")),
                    (L = function(t) {
                        return t
                            .replace(RegExp("" + y.source, "g"), " ")
                            .replace(/\ {2,}/g, " ");
                    }),
                    (x = function(t) {
            ...
            (e.Document = (function(s) {
                ...
                return (
                    ...
                    (c.fromJSON = function(t) {
                        ...
                        return (
                            (o = (function() {
                                var o, i, r;
                                for (r = [], o = 0, i = t.length; i > o; o++)
                                    (n = t[o]), r.push(e.Block.fromJSON(n));
                                return r;
                            })()),
                            new this(o)
                        );
                    ...
                    (c.fromString = function(t, n) {
                        var o;
                        return (
                            (o = e.Text.textForStringWithAttributes(t, n)),
                            new this([new e.Block(o)])
                        );
                    }),
                    ...
                    (c.prototype.copyUsingObjectMap = function(t) {
                        ...
                        return (
                            (n = function() {
                                var n, i, r, s;
                                for (
                                    r = this.getBlocks(), s = [], n = 0, i = r.length;
                                    i > n;
                                    n++
                                )
                                    (e = r[n]),
                                    s.push((o = t.find(e)) ? o : e.copyUsingObjectMap(t));
                                return s;
                            }.call(this)),
                            new this.constructor(n)
                        );
                    ...
                    (c.prototype.copyWithBaseBlockAttributes = function(t) {
                        ...
                        return (
                            ...
                            (o = function() {
                                var o, i, r, s;
                                for (
                                    r = this.getBlocks(), s = [], o = 0, i = r.length;
                                    i > o;
                                    o++
                                )
                                    (n = r[o]),
                    ...
                    (c.prototype.mergeDocumentAtRange = function(e, n) {
                        ...
                        return (
                            ...
                            (i = e.getBaseBlockAttributes()),
                            (g = r.slice(-i.length)),
                            t(i, g)
                                ? ((l = r.slice(0, -i.length)),
                        ...
                        return (
                          ...
                          "\n" === m.text.getStringAtPosition(b)),
                              ...
                              s.getAttributeLevel() >= m.getAttributeLevel()),
                                    (n = x ? m.copyWithText(w) : s.copyWithText(w)),
                                    (e = y + 1 - a),
                    ...
                    (c.prototype.addAttributeAtRange = function(t, e, o) {
                        ...
                        return (
                            (i = this.blockList),
                            this.eachBlockAtRange(o, function(o, r, s) {
                                return (i = i.editObjectAtIndex(s, function() {
                                    return n(t)
                                        ? o.addAttribute(t, e)
                                        : r[0] === r[1]
                                            ? o
                                            : o.copyWithText(o.text.addAttributeAtRange(t, e, r));
                                }));
                            }),
                    ...
                    (c.prototype.removeAttributeAtRange = function(t, e) {
                        ...
                        return (
                            (o = this.blockList),
                            this.eachBlockAtRange(e, function(e, i, r) {
                                return n(t)
                                    ? (o = o.editObjectAtIndex(r, function() {
                    ...
                    (c.prototype.updateAttributesForAttachment = function(t, e) {
                        var n, o, i, r;
                        return (
                            (i = (o = this.getRangeOfAttachment(e))[0]),
                    ...
                    (c.prototype.applyBlockAttributeAtRange = function(t, e, o) {
                        var i, r, s, a;
                        return (
                            (s = this.expandRangeToLineBreaksAndSplitBlocks(o)),
                            (r = s.document),
                            (o = s.range),
                            (i = n(t)),
                            i.listAttribute
                                ? ((r = r.removeLastListAttributeAtRange(o, {
                                    exceptAttributeName: t
                                })),
                                (a = r.convertLineBreaksToBlockBreaksInRange(o)),
                                (r = a.document),
                                (o = a.range))
                                : (r = i.terminal
                                    ? r.removeLastTerminalAttributeAtRange(o)
                                    : r.consolidateBlocksAtRange(o)),
                            r.addAttributeAtRange(t, e, o)
                        );
                    }),
                    (c.prototype.removeLastListAttributeAtRange = function(t, e) {
                        ...
                        s !== e.exceptAttributeName
                                    ...
                                    return (o = o.editObjectAtIndex(r, function() {
                    ...
                    (c.prototype.removeLastTerminalAttributeAtRange = function(t) {
                        ...
                        return (
                            (e = this.blockList),
                            this.eachBlockAtRange(t, function(t, o, i) {
                                var r;
                    ...
                    (c.prototype.firstBlockInRangeIsEntirelySelected = function(t) {
                        ...
                        return (
                            ...
                            (a = r[0]),
                            (e = r[1]),
                            (n = this.locationFromPosition(a)),
                            (s = this.locationFromPosition(e)),
                            0 === n.offset && n.index < s.index
                                ? !0
                                : n.index === s.index
                                    ? ((i = this.getBlockAtIndex(n.index).getLength()),
                                    0 === n.offset && s.offset === i)
                                    : !1
                        );
                    }),
                    (c.prototype.expandRangeToLineBreaksAndSplitBlocks = function(
                      ...
                      (i.index += 1),
                      (i.offset -= e.getBlockAtIndex(c.index).getLength()),
                      (c.index += 1)),
                            (c.offset = 0),
                            0 === i.offset && i.index > c.index
                                ...
                                : ((n = e.getBlockAtIndex(i.index)),
                                "\n" ===
                        n.text.getStringAtRange([i.offset - 1, i.offset])
                                    ? (i.offset -= 1)
                          ...
                          ((s = e.positionFromLocation(i)),
                          (e = e.insertBlockBreakAtRange([s, s + 1])))),
                            (l = e.positionFromLocation(c)),
                            (r = e.positionFromLocation(i)),
                            (t = o([l, r])),
                            { document: e, range: t }
                        );
                    }),
                    ...
                    (c.prototype.getCommonAttributesAtPosition = function(t) {
                        ...
                        (o = i.text.getAttributesAtPosition(h - 1)),
                        (a = (function() {
                            var t, n;
                        ...
                        for (c in o)
                            (d = o[c]), (d === n[c] || u.call(a, c) >= 0) && (r[c] = d);
                        return r;
                    }),
                    (c.prototype.getRangeOfCommonAttributeAtPosition = function(
                        ...
                        return (
                            ...
                            (n = this.positionFromLocation({ index: r, offset: i })),
                            o([c, n])
                        );
                    }),
                    ...
                    (c.prototype.getAttachmentById = function(t) {
                        var e, n, o, i;
                        for (
                            i = this.getAttachments(), n = 0, o = i.length;
                            o > n;
                            n++
                        )
                    ...
                    (c.prototype.getAttachmentPieceForAttachment = function(t) {
                        var e, n, o, i;
                        for (
                            i = this.getAttachmentPieces(), e = 0, n = i.length;
                            n > e;
                            e++
                        )
                    ...
                    (c.prototype.getTexts = function() {
                        var t, e, n, o, i;
                        for (
                            o = this.getBlocks(), i = [], e = 0, n = o.length;
                            n > e;
                            e++
                        )
                            (t = o[e]), i.push(t.text);
                    ...
                    (c.prototype.getPieces = function() {
                        var t, e, n, o, i;
                        for (
                            n = [], o = this.getTexts(), t = 0, e = o.length;
                            e > t;
                            t++
                        )
                            (i = o[t]), n.push.apply(n, i.getPieces());
                        return n;
                    }),
                        ...
                        return JSON.stringify(
                            function() {
                                ...
                                for (
                                    ...
                                    (t = o[e]), i.push(JSON.parse(t.text.toConsole()));
                                return i;
                            }.call(this)
                        );
                    }),
                ...
                return (
                    ...
                    (d.prototype.loadSnapshot = function(t) {
                        ...
                        return (
                            ...
                            (r = t.selectedRange),
                            null != (o = this.delegate) &&
                      "function" == typeof o.compositionWillLoadSnapshot &&
                      o.compositionWillLoadSnapshot(),
                    ...
                    (d.prototype.insertText = function(t, e) {
                        ...
                        return (
                            ...
                            this.setDocument(this.document.insertTextAtRange(t, o)),
                            (i = o[0]),
                            (n = i + t.getLength()),
                    ...
                    (d.prototype.insertDocument = function(t) {
                        ...
                        return (
                            ...
                            (o = this.getSelectedRange()),
                            this.setDocument(this.document.insertDocumentAtRange(t, o)),
                            (i = o[0]),
                            (n = i + t.getLength()),
                            this.setSelection(n),
                            this.notifyDelegateOfInsertionAtRange([i, n])
                    ...
                    (d.prototype.insertString = function(t, n) {
                        ...
                        return (
                            ...
                            (i = e.Text.textForStringWithAttributes(t, o)),
                            this.insertText(i, n)
                        );
                    }),
                    ...
                    (d.prototype.replaceHTML = function(t) {
                        ...
                        return (
                            ...
                            (o = this.getLocationRange({ strict: !1 })),
                            (i = this.document.rangeFromLocationRange(o)),
                            this.setDocument(n),
                            this.setSelection(i)
                        );
                    }),
                    (d.prototype.insertFile = function(t) {
                        var n, o;
                        return (null != (o = this.delegate)
                            ? o.compositionShouldAcceptFile(t)
                            : void 0)
                            ? ((n = e.Attachment.attachmentForFile(t)),
                            this.insertAttachment(n))
                            : void 0;
                    }),
                    (d.prototype.insertAttachment = function(t) {
                        var n;
                        return (
                            (n = e.Text.textForAttachmentWithAttributes(
                                t,
                                this.currentAttributes
                            )),
                            this.insertText(n)
                    ...
                    (d.prototype.deleteInDirection = function(t) {
                        ...
                        return (
                            ...
                            s &&
                      "backward" === t &&
                      ((i = this.document.locationFromPosition(r[0]).offset),
                      (o = 0 === i)),
                            o &&
                    ...
                    n.isEmpty())
                          ...
                          "backward" === t &&
                            (e = this.getAttachmentAtRange(r))),
                                e
                                    ? (this.editAttachment(e), !1)
                                    : (this.setDocument(
                                        this.document.removeTextAtRange(r)
                                    ),
                                    this.setSelection(r[0]),
                                    o ? !1 : void 0))
                        );
                    ...
                    (d.prototype.setTextAttribute = function(t, n) {
                        ...
                        if ((i = this.getSelectedRange()))
                            return (
                                ...
                                r !== o
                                    ? this.setDocument(
                                        this.document.addAttributeAtRange(t, n, i)
                                    )
                                    : "href" === t
                    ...
                    (d.prototype.setBlockAttribute = function(t, e) {
                        ...
                        if ((o = this.getSelectedRange()))
                            return this.canSetCurrentAttribute(t)
                                ? ((n = this.getBlock()),
                                this.setDocument(
                                    this.document.applyBlockAttributeAtRange(t, e, o)
                                ),
                                this.setSelection(o))
                                : void 0;
                    }),
                    ...
                    (d.prototype.canIncreaseNestingLevel = function() {
                        var e, n, o;
                        if ((e = this.getBlock()))
                            return (null != (o = i(e.getLastNestableAttribute()))
                                ? o.listAttribute
                                : 0)
                    ...
                    (d.prototype.decreaseListLevel = function() {
                        ...
                        for (
                            ...
                            i = this.document.locationFromPosition(r).index,
                            n = i,
                    ...
                    e.getAttributeLevel() > t;
                        ...
                        return (
                            ...
                            this.setDocument(
                                this.document.removeLastListAttributeAtRange([r, o])
                            )
                        );
                    }),
                    ...
                    (d.prototype.getLocationRange = function(t) {
                        var e;
                        return null !=
                    (e = this.getSelectionManager().getLocationRange(t))
                            ? e
                            : s({ index: 0, offset: 0 });
                    }),
                    (d.prototype.getExpandedRangeInDirection = function(t) {
                        ...
                        return (
                            ...
                            "backward" === t
                                ...
                                : (e = this.translateUTF16PositionFromOffset(e, 1)),
                            s([o, e])
                        );
                    }),
                    ...
                    (d.prototype.selectionContainsAttachmentWithAttribute = function(
                        t
                    ) {
                        var e, n, o, i, r;
                        if ((r = this.getSelectedRange())) {
                            for (
                                i = this.document.getDocumentAtRange(r).getAttachments(),
                                n = 0,
                                o = i.length;
                                o > n;
                                n++
                    ...
                    (d.prototype.editAttachment = function(t) {
                        ...
                        if (t !== this.editingAttachment)
                            return (
                                ...
                                null != (e = this.delegate) &&
                      "function" ==
                        typeof e.compositionDidStartEditingAttachment
                    ...
                    (d.prototype.breakFormattedBlock = function(t) {
                        ...
                        return (
                            ...
                            this.setDocument(o.insertDocumentAtRange(i, s)),
                            this.setSelection(r)
                        );
                    }),
                    ...
                    (d.prototype.translateUTF16PositionFromOffset = function(t, e) {
                        var n, o;
                        return (
                            (o = this.document.toUTF16String()),
                            (n = o.offsetFromUCS2Offset(t)),
                            o.offsetToUCS2Offset(n + e)
                        );
                    }),
                    d
                );
                ...
                return (
                    ...
                    (n.prototype.recordUndoEntry = function(t, e) {
                        ...
                        return (
                            ...
                            n && o(r, t, i)
                                ? void 0
                                : ((a = this.createEntry({ description: t, context: i })),
                ...
                return (
                    ...
                    (t.prototype.loadJSON = function(t) {
                        ...
                        return (
                            ...
                            this.loadSnapshot({ document: n, selectedRange: o })
                        );
                    }),
            ...
            e.AttachmentManager = (function(n) {
                ...
                return (
                    ...
                    (o.prototype.manageAttachment = function(t) {
                        var n, o;
                        return null != (n = this.managedAttachments)[(o = t.id)]
                            ? n[o]
                            : (n[o] = new e.ManagedAttachment(this, t));
                    }),
        ...
        function() {
            ...
            (a = e.nodeIsBlockStart),
            (u = e.nodeIsBlockStartComment),
            (s = e.nodeIsBlockContainer),
            (c = e.nodeIsCursorTarget),
            (l = e.nodeIsEmptyTextNode),
            (h = e.nodeIsTextNode),
            (r = e.nodeIsAttachmentElement),
            (p = e.tagName),
            (d = e.walkTree),
            (e.LocationMapper = (function() {
                ...
                return (
                    (e.prototype.findLocationFromContainerAndOffset = function(
                        ...
                        ((e = s.parentNode), (o = n(s))),
                            y = d(this.element, { usingFilter: f });
                            y.nextNode();
                    ...
                    (e.prototype.findContainerAndOffsetFromLocation = function(t) {
                        ...
                        if (
                            ((u = this.findNodeAndOffsetFromLocation(t)),
                            (o = u[0]),
                            (i = u[1]),
                            o)
                        ) {
                    ...
                    (e.prototype.getSignificantNodesForIndex = function(t) {
                        var e, n, i, r, s;
                        for (
                            i = [], s = d(this.element, { usingFilter: o }), r = !1;
                            s.nextNode();
            ...
            (e.SelectionChangeObserver = (function(e) {
                ...
                return (
                    ...
                    (i.prototype.unregisterSelectionManager = function(t) {
                        ...
                        return (
                            (this.selectionManagers = function() {
                                var n, o, i, r;
                                for (
                                    i = this.selectionManagers, r = [], n = 0, o = i.length;
                                    o > n;
                                    n++
                                )
                                    (e = i[n]), e !== t && r.push(e);
                    ...
                    (i.prototype.notifySelectionManagersOfSelectionChange = function() {
                        var t, e, n, o, i;
                        for (
                            n = this.selectionManagers, o = [], t = 0, e = n.length;
                            e > t;
                            t++
                        )
                            (i = n[t]), o.push(i.selectionDidChange());
                        return o;
                    }),
        ...
        function() {
            ...
            (t = e.defer),
            (n = e.elementContainsNode),
            (u = e.nodeIsCursorTarget),
            (a = e.innerElementIsActive),
            (r = e.handleEvent),
            (s = e.handleEventOnce),
            (c = e.normalizeRange),
            (l = e.rangeIsCollapsed),
            (h = e.rangesAreEqual),
            (e.SelectionManager = (function(t) {
                function s(t) {
                    (this.element = t),
                    (this.selectionDidChange = d(this.selectionDidChange, this)),
                    (this.didMouseDown = d(this.didMouseDown, this)),
                ...
                return (
                    f(s, t),
                    (s.prototype.getLocationRange = function(t) {
                        var e, n;
                        return (
                            null == t && (t = {}),
                            (e =
                      t.strict === !1
                          ? this.createLocationRangeFromDOMRange(o(), {
                              strict: !1
                          })
                          : t.ignoreLock
                        ...
                        if (!this.lockedLocationRange)
                            return (
                                ...
                                (e = this.createDOMRangeFromLocationRange(t))
                                    ? (p(e), this.updateCurrentLocationRange(t))
                                    : void 0
                            );
                    }),
                    ...
                    (s.prototype.locationIsCursorTarget = function(t) {
                        var e, n, o;
                        return (
                            (o = this.findNodeAndOffsetFromLocation(t)),
                            (e = o[0]),
                            (n = o[1]),
                            u(e)
                        );
                    ...
                    s.proxyMethod("locationMapper.findNodeAndOffsetFromLocation"),
                    s.proxyMethod("pointMapper.createDOMRangeFromPoint"),
                    s.proxyMethod("pointMapper.getClientRectsForDOMRange"),
                    (s.prototype.didMouseDown = function() {
                        ...
                        return (
                            ...
                            (e = (function(t) {
                                return function() {
                                    var e, r, s;
                                    for (
                                        t.paused = !1, clearTimeout(i), r = 0, s = o.length;
                                        s > r;
                                        r++
                                    )
                                        (e = o[r]), e.destroy();
                                    return n(document, t.element)
                            ...
                            (o = (function() {
                                ...
                                for (
                                    ...
                                    (t = i[n]),
                                    s.push(
                                        r(t, { onElement: document, withCallback: e })
                                    );
                                return s;
                            })())
                        );
                    ...
                    (s.prototype.selectionDidChange = function() {
                        return this.paused || a(this.element)
                            ? void 0
                            : this.updateCurrentLocationRange();
                    }),
                    (s.prototype.updateCurrentLocationRange = function(t) {
                        ...
                        return (null != t
                            ? t
                            : (t = this.createLocationRangeFromDOMRange(o()))) &&
                    !h(t, this.currentLocationRange)
                    ...
                    (s.prototype.createDOMRangeFromLocationRange = function(t) {
                        var e, n, o, i;
                        return (
                            (o = this.findContainerAndOffsetFromLocation(t[0])),
                            (n = l(t)
                                ? o
                                : null !=
                        (i = this.findContainerAndOffsetFromLocation(t[1]))
                                    ? i
                                    : o),
                            null != o && null != n
                                ? ((e = document.createRange()),
                                e.setStart.apply(e, o),
                                e.setEnd.apply(e, n),
                                e)
                                : void 0
                        );
                    ...
                    (o = this.findLocationFromContainerAndOffset(
                        t.startContainer,
                        t.startOffset,
                        e
                    ))
                    ...
                    (s.prototype.domRangeWithinElement = function(t) {
                        return t.collapsed
                            ? n(this.element, t.startContainer)
                            : n(this.element, t.startContainer) &&
                        n(this.element, t.endContainer);
                    }),
                    s
                );
            })(e.BasicObject));
        ...
        function() {
            var t,
                ...
                r = {}.hasOwnProperty,
                s = [].slice;
            (n = e.rangeIsCollapsed),
            (o = e.rangesAreEqual),
            (t = e.objectsAreEqual),
            (e.EditorController = (function(r) {
                function a(t) {
                    var n, o;
                    ...
                    (this.inputController = new e.InputController(
                        this.editorElement
                    )),
                    ...
                    null != n
                        ...
                        : this.editor.loadHTML(o);
                }
                return (
                    i(a, r),
                    (a.prototype.registerSelectionManager = function() {
                    ...
                    (a.prototype.compositionDidChangeCurrentAttributes = function(
                        t
                    ) {
                        return (
                    ...
                    (a.prototype.compositionDidPerformInsertionAtRange = function(
                        t
                    ) {
                    ...
                    (a.prototype.compositionDidAddAttachment = function(t) {
                        ...
                        return (
                            ...
                            this.editorElement.notify("attachment-add", {
                                attachment: e
                            })
                        );
                    }),
                    ...
                    (a.prototype.compositionDidChangeAttachmentPreviewURL = function(
                        t
                    ) {
                        return (
                    ...
                    (a.prototype.compositionDidRemoveAttachment = function(t) {
                        ...
                        return (
                            ...
                            this.editorElement.notify("attachment-remove", {
                                attachment: e
                            })
                        );
                    }),
                    (a.prototype.compositionDidStartEditingAttachment = function(
                        t
                    ) {
                        return (
                    ...
                    (a.prototype.compositionDidRequestChangingSelectionToLocationRange = function(
                        t
                    ) {
                    ...
                    a.proxyMethod("getSelectionManager().setLocationRange"),
                    a.proxyMethod("getSelectionManager().getLocationRange"),
                    (a.prototype.attachmentManagerDidRequestRemovalOfAttachment = function(
                        t
                    ) {
                    ...
                    (a.prototype.compositionControllerDidSelectAttachment = function(
                        t
                    ) {
                        return this.composition.editAttachment(t);
                    }),
                    (a.prototype.compositionControllerDidRequestDeselectingAttachment = function(
                        t
                    ) {
                        var e, n;
                        return (
                    ...
                    (a.prototype.compositionControllerWillUpdateAttachment = function(
                        t
                    ) {
                    ...
                    (a.prototype.compositionControllerDidRequestRemovalOfAttachment = function(
                        t
                    ) {
                        return this.removeAttachment(t);
                    }),
                    ...
                    (a.prototype.inputControllerWillPasteText = function() {
                        return (
                            this.editor.recordUndoEntry("Paste"), (this.pasting = !0)
                        );
                    }),
                    ...
                    (a.prototype.inputControllerDidReceiveKeyboardCommand = function(
                        t
                    ) {
                    ...
                    (a.prototype.inputControllerDidReceiveDragOverPoint = function(
                        t
                    ) {
                    ...
                    (a.prototype.invokeAction = function(t) {
                        var e, n;
                        return this.actionIsExternal(t)
                            ? this.editorElement.notify("action-invoke", {
                                actionName: t
                            })
            ...
            e.registerElement(
                ...
                (function() {
                    ...
                    return (
                      ...
                      t +
                      "[data-trix-mutable] figcaption:empty::before {\n  content: \"" +
                      e.config.lang.captionPrompt +
                      "\";\n  color: graytext;\n}\n\n%t " +
                      s.selector +
                      " { " +
                      s.cssText +
                      " }",
                            trixId: {
                                get: function() {
                                    return this.hasAttribute("trix-id")
                                        ...
                                        : (this.setAttribute("trix-id", ++l), this.trixId);
                                }
                            },
                            toolbarElement: {
                                get: function() {
                            ...
                            this.notify("change"));
                                ...
                                case "attachment-remove":
                                    null != (o = this.inputElement) &&
                            (o.value = e.serializeToContentType(
                                this,
                                "text/html"
                            ));
                                }
                                return this.editorController
                                    ? a("trix-" + t, { onElement: this, attributes: n })
                                    : void 0;
                            },
                            createdCallback: function() {
                                return h(this);
